      ...
      <AnimatedSection delay={0.15}>
        <div className="rounded-[32px] border border-border/75 bg-surface/48 px-6 py-7 shadow-[0_26px_72px_rgba(2,8,23,0.2)] backdrop-blur-md sm:px-8">
          <div className="space-y-5 text-base leading-7 text-text-secondary">
            ...
            <p>
              I currently work in <span className="text-text-primary">AI R&D</span> at <span className="text-accent-cyan">Amazon Lab126</span>, contributing to embedded AI and multimodal systems research focused on real-world intelligent systems.
            </p>
            <p>
