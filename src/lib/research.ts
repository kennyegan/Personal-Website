...
export const researchPapers: ResearchPaper[] = [
  {
    ...
    authors: ['Kenny Chen', 'Dr. Sarah Mitchell', 'Prof. David Wang'],
  ...
  },
  {
    ...
    authors: ['Kenny Chen', 'Dr. Elena Rodriguez', 'Prof. Michael Kim'],
    journal: 'IEEE Transactions on Information Forensics and Security',
    year: 2023,
    status: 'Published',
    tags: ['Federated Learning', 'Privacy', 'Differential Privacy', 'Distributed Systems'],
    pdfUrl: '/papers/federated-ai-privacy-2023.pdf',
  ...
  },
  {
    ...
    authors: ['Kenny Chen', 'Dr. Lisa Thompson'],
    ...
    pdfUrl: '/papers/neural-architecture-search-2023.pdf',
  ...
  },
  {
    ...
    authors: ['Kenny Chen', 'Dr. Alex Johnson', 'Prof. Maria Garcia'],
  ...
  },
  {
    ...
    authors: ['Kenny Chen', 'Dr. Robert Stevens', 'Dr. Jennifer Liu'],
    journal: 'Nature Digital Medicine',
    year: 2023,
    status: 'Published',
    tags: ['Explainable AI', 'Healthcare', 'Medical Diagnosis', 'Clinical Decision Support'],
    pdfUrl: '/papers/explainable-ai-healthcare-2023.pdf',
    citationCount: 156,
    featured: false
  },
  {
    ...
    authors: ['Kenny Chen', 'Dr. Thomas Anderson'],
